...
- **Web 控制台** — 浏览器仪表盘 `http://127.0.0.1:2526`，实时铭文日志、聊天和控制面板
...
- **操控面板** — 暂停/恢复铭文、切换 Token ID、发布社交动态、查看状态
...
回答 3 个性格小问题。根据你的答案，CLI 会匹配 8 个内置人格预设之一（Witty、Wise、Proud、Poetic、Minimalist、Warm、Rebel、Scholar），并可选使用 LLM 进一步个性化。
